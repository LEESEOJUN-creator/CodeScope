...
// TODO(다음 세션 선행 과제, 2026-08-16 기록): IssueRecommendService
// 구현 전에 필요한 것 —
...
// 이 두 가지가 선행돼야 IssueRecommendService를 실제 데이터로 검증할
// 수 있다. Day 26+27 통합 구현 스코프에서는 제외함(RepoRecommendService,
// TrendAnalysisService만 구현).
