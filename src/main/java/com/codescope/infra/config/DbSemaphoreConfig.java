 ...
 *     }
 *
 * AOP/어노테이션 기반 자동 적용 대신 수동 try-finally를 쓰는 건 가시성을
 * 우선한 확정된 설계 결정이다.
 */
@Slf4j
@Configuration
public class DbSemaphoreConfig {
    ...
    public Semaphore dbSemaphore(
            ...
            // 기본값 2(잠정치) — 부하 테스트에서 reserve 유무의 효과가 뚜렷하게
            // 관찰되지 않아(docs/performance/day35_backpressure.md), 세부 튜닝은
            // 추가 실험 과제로 남아있다. 세마포어 자체의 존재 여부가 더 지배적인 요인.
